...
noremap <silent>  :exe "tabn ".g:lasttab
noremap \+ :tabm+1
noremap \- :tabm-1
noremap \p "+p
...
noremap <silent> <C-L> :exe "tabn ".g:lasttab
noremap <M-l> l
noremap <M-k> k
noremap <M-j> j
noremap <M-h> h
...
silent only
silent tabonly
cd ~/Documents/CppND-System-Monitor-Project-Updated-JT
...
argglobal
%argdel
$argadd src/ncurses_display.cpp
set stal=2
tabnew
tabnew
tabnew
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
wincmd w
argglobal
if bufexists("include/system.h") | buffer include/system.h | else | edit include/system.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("include/process.h") | buffer include/process.h | else | edit include/process.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
silent! normal! zE
25,27fold
let s:l = 56 - ((28 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((18 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 54 + 34) / 69)
exe '2resize ' . ((&lines * 12 + 34) / 69)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
282
normal! zo
let s:l = 442 - ((44 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
442
...
wincmd w
argglobal
if bufexists("include/linux_parser.h") | buffer include/linux_parser.h | else | edit include/linux_parser.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("include/processor.h") | buffer include/processor.h | else | edit include/processor.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
set stal=1
badd +6 src/main.cpp
badd +1 src/format.cpp
badd +23 src/system.cpp
badd +191 src/linux_parser.cpp
badd +1 src/process.cpp
badd +1 src/processor.cpp
badd +5 include/processor.h
badd +1 /mnt/d/Dropbox/Udacity/2-OOP/test.cpp
badd +10 include/linux_parser.h
badd +19 ~/.vimrc
badd +3 include/format.h
badd +72 src/ncurses_display.cpp
badd +1 ~/.bashrc
badd +1 ~/token.txt
badd +9 include/process.h
badd +135 ~/.tmux.conf
badd +12 include/ncurses_display.h
badd +14 include/system.h
badd +85 ~/Udacity/2-OOP/Notes_OOP.txt
badd +8 ~/Udacity/2-OOP/composition.cpp
